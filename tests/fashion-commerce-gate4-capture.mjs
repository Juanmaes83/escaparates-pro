...
const outDir = path.join(root, 'tests', 'phase-gate4-evidence');
...
const sourceSections = [
  { name: 'lookbook', id: 'section2' },
  { name: 'cocreation', id: 'section8' },
  { name: 'style-generator', id: 'section10' },
  { name: 'timeline-designers', id: 'section7' },
  { name: 'videogrid', id: 'section3' },
  { name: 'polaroid', id: 'section4' }
];
...
async function run() {
  ...
  for (const vp of viewports) {
    ...
    await page.goto(`http://127.0.0.1:${port}/tests/phase-gate4-evidence/builder-exported.html`, { waitUntil: 'domcontentloaded' });
