...
EP.ScrollSectionsUI = (function() {
    var FIELD_SCHEMAS = {
        ...
        'product-scroll-scrub-features-pro': [
            { key: 'brand', type: 'text', label: 'Marca', default: 'Escaparates Pro' },
            { key: 'productName', type: 'text', label: 'Nombre del producto', default: 'Producto' },
            { key: 'headline', type: 'text', label: 'Titular', default: 'Diseñado para destacar.' },
            { key: 'subtitle', type: 'text', label: 'Subtítulo', default: 'Cada detalle responde a una idea: hacer que el producto se sienta irresistible.' },
            { key: 'eyebrow', type: 'text', label: 'Etiqueta superior', default: 'Nuevo lanzamiento' },
            { key: 'feature1Label', type: 'text', label: 'Feature 1 — Etiqueta', default: '01' },
            { key: 'feature1Title', type: 'text', label: 'Feature 1 — Título', default: 'Materiales premium' },
            { key: 'feature1Text', type: 'text', label: 'Feature 1 — Texto', default: 'Acabados seleccionados para una sensación de calidad inmediata.' },
            { key: 'feature2Label', type: 'text', label: 'Feature 2 — Etiqueta', default: '02' },
            { key: 'feature2Title', type: 'text', label: 'Feature 2 — Título', default: 'Diseño funcional' },
            { key: 'feature2Text', type: 'text', label: 'Feature 2 — Texto', default: 'Cada curva y cada junta responden a un propósito real.' },
            { key: 'feature3Label', type: 'text', label: 'Feature 3 — Etiqueta', default: '03' },
            { key: 'feature3Title', type: 'text', label: 'Feature 3 — Título', default: 'Rendimiento optimizado' },
            { key: 'feature3Text', type: 'text', label: 'Feature 3 — Texto', default: 'Tecnología que mejora la experiencia sin complicarla.' },
            { key: 'feature4Label', type: 'text', label: 'Feature 4 — Etiqueta', default: '' },
            { key: 'feature4Title', type: 'text', label: 'Feature 4 — Título', default: '' },
            { key: 'feature4Text', type: 'text', label: 'Feature 4 — Texto', default: '' },
            { key: 'ctaLabel', type: 'text', label: 'Texto CTA', default: 'Descubrir más' },
            { key: 'ctaUrl', type: 'text', label: 'URL CTA', default: '#' },
            { key: 'scrollLength', type: 'range', label: 'Longitud de scroll', min: 300, max: 900, step: 10, default: 520, suffix: ' vh' },
            { key: 'scrubSmoothing', type: 'range', label: 'Suavizado scrub', min: 0.03, max: 0.30, step: 0.01, default: 0.12 },
            { key: 'featureRevealStart', type: 'range', label: 'Inicio revelado features', min: 0, max: 1, step: 0.01, default: 0.18 },
            { key: 'featureRevealEnd', type: 'range', label: 'Fin revelado features', min: 0, max: 1, step: 0.01, default: 0.78 },
            { key: 'showNavigation', type: 'text', label: 'Mostrar navegación (true | false)', default: 'true' },
            { key: 'showProgress', type: 'text', label: 'Mostrar barra de progreso (true | false)', default: 'true' },
            { key: 'showPercentage', type: 'text', label: 'Mostrar porcentaje (true | false)', default: 'true' },
            { key: 'showAudioControl', type: 'text', label: 'Mostrar control de audio (true | false)', default: 'true' },
            { key: 'overlayStrength', type: 'range', label: 'Oscurecimiento', min: 0, max: 0.85, step: 0.01, default: 0.35 },
            { key: 'primaryColor', type: 'text', label: 'Color primario', default: '#ffffff' },
            { key: 'secondaryColor', type: 'text', label: 'Color secundario', default: '#8a8f9c' },
            { key: 'backgroundColor', type: 'text', label: 'Color de fondo', default: '#0b0d12' },
            { key: 'textColor', type: 'text', label: 'Color de texto', default: '#f4f0e8' }
        ]
    };
