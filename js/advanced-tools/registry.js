(function(){
  ...
  register({
    ...
    icon:'〰',
    version:'1.0.0-type-b-local-source',
    status:'visual-review',
    description:'Authoring Type B para Flexible Media / Dynamic Fabric con WebGL + Verlet/cloth preservado, media, composición, proyectos y outputs.',
    source:{
      repository:'Juanmaes83/BANDEROLAS-DINAMICAS',
      branch:'preview-output-v2',
      commit:'538146f7ec2ddbd056b55da0ed0eb8a1cf96ef83',
      blob:'9fc683b9e988a56a8426d094bde3c4bcaa25e372',
      enhancerBlob:'e496e414b5ae7d77c82583ad1a071c1ee42c52f5',
      wrapperBlob:'4cb27137abba038d87d025db48b4967ba1185a84',
      entrypoint:'index-output-v2.html',
      outputReference:'index-output-v2.html',
      enhancerReference:'output-enhancer-v2.js',
      localRoot:'labs/immersive-worlds/shared-capabilities/flexible-media/banderolas/source/',
      url:'labs/immersive-worlds/shared-capabilities/flexible-media/banderolas/source/index-output-v2.html',
      engineUrl:'labs/immersive-worlds/shared-capabilities/flexible-media/banderolas/source/index.html',
      fallbackUrl:'labs/immersive-worlds/shared-capabilities/flexible-media/banderolas/source/index-output-v2.html',
      originUrl:'https://github.com/Juanmaes83/BANDEROLAS-DINAMICAS/tree/preview-output-v2'
    },
