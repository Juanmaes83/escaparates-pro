...
function label(id){var def=EP.StudioTemplateRegistry&&EP.StudioTemplateRegistry.get&&EP.StudioTemplateRegistry.get(id);return(def&&(def.shortTitle||def.title))||{'real-estate-storytelling-custom-pro':'Real Estate Storytelling','product-storytelling-custom-pro':'Product Storytelling','luxury-real-estate-custom-pro':'Luxury Real Estate'}[id]||id||'Custom PRO'}
