(function() {
    var effect = new EP.EffectBase('ticker-loop', {
        ...
        { key: 'opacity', type: 'range', min: 20, max: 100, default: 95, label: 'Opacity', unit: '%' },
    ...
    effect.build = function(mediaList) {
        ...
        var ar = ratioMap[this.settings.cardRatio] || 1.33;
        ...
        for (var r = 0; r < rows; r++) {
            ...
            var y = (r - (rows - 1) / 2) * (cardH + gap);
            rowGroup.position.y = y;
            rowGroup.rotation.z = tilt * (r % 2 === 0 ? 1 : -1);
            rowGroup.userData = { direction: r % 2 === 0 ? 1 : -1, cardW: cardW + gap, perRow: perRow };

            var geo = EP.RoundedPlaneGeometry(cardW, cardH, cr);
            ...
            for (var c = 0; c < perRow; c++) {
                ...
                mesh.position.x = (c - perRow / 2) * (cardW + gap);
    ...
    effect.update = function(time, dt, loopDuration) {
        ...
        var opacity = (this.settings.opacity || 95) / 100;
