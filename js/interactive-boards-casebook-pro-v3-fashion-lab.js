...
(function() {
    ...
    EP.InteractiveBoards.register({
        ...
        description: 'Casebook PRO V4 dentro de Boards: Fashion Pearl Spatial World con escena couture 3D, cámara libre en Author Mode, Fit Scene, Chapters, Hotspots, World Map / Route y Guided Experience.',
        path: PATH,
        sourceFile: PATH,
        status: 'approved-v4-board',
        baseline: 'Approved Fashion Pearl candidate promoted from Casebook PRO V3 research line.',
