...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ds(e,t,n){let r=new Float32Array(ps),i=new H(0,1,0);return new Ea({name:`SphericalGaussianBlur`,defines:{n:ps,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:As(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Os(){return new Ea({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:As(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ks(){return new Ea({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:As(),fragmentShader:`
	...
	`}var js=class extends Qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new oa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
  ...
  `,fragmentShader:`
    ...
    void main() {
      ...
      if (uPass == 1) {
        gl_FragColor = vec4(${tf.IMAGE.toFixed(1)} / 255.0, 0.0, 0.0, 1.0);
        return;
      }
      if (uPass == 2) {
  ...
  `}),pf=new ii(new ma(2,2),ff);uf.add(pf);var mf=null,hf=null,gf=``,_f=[],vf=null,yf=``,bf=0,xf=new Map,Sf=!1,Cf=0,wf=null,Tf=[],Ef=``,Df=null,Of=``,kf=``,Af=!1,jf=!1,Mf=!1,Nf=!1,Pf=8,Ff=Object.freeze({sphere:{label:`球体`,color:12154942,create:()=>new ha(2,64,40)},cube:{label:`立方体`,color:5402013,cameraDistanceScale:1.16,create:()=>new ua(3.5,3.5,3.5,10,10,10)},torus:{label:`圆环`,color:6718828,create:()=>new ga(1.65,.62,32,96),rotation:[.34,-.42,.12]},knot:{label:`扭结`,color:10444120,create:()=>new _a(1.35,.42,160,28,2,3),rotation:[.2,-.35,-.12]}}),If=new lo(11257320,7095071,2.2);af.add(If);var Lf=new ko(16777215,2.8);Lf.position.set(-5,9,4),af.add(Lf);function Rf(e,t={}){let n=Mt.clamp(Number(e)||0,-180,180),r=Mt.degToRad(n);X.modelLightAngle=n,Lf.position.set(Math.sin(r)*7.5,8.5,Math.cos(r)*7.5),Lf.updateMatrixWorld(),md.value=String(Math.round(n)),hd.textContent=`${Math.round(n)}°`,document.documentElement.dataset.modelLightAngle=String(Math.round(n)),Sp=!0,Np=!0,wf&&(jf=!0),t.finalize&&(yp=!0,Y.textContent=`环境光角度 · ${Math.round(n)}°`,Fm()),nm()}var zf=[],Bf;function Vf(e,t){return e.userData.semantic=t,zf.push(e),af.add(e),e}function Hf(){Bf=new Ea({side:2,depthWrite:!1,uniforms:{uTime:{value:0}},vertexShader:`
      varying vec2 vUv;
      void main() {
        vUv = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `});let e=new ii(new ma(48,27,1,1),Bf);e.position.set(0,5,-17),Vf(e,tf.SKY);let t=new ii(new da(1.02,64),new Kr({color:15975262,fog:!1}));t.position.set(-4.6,4.6,-15.7),Vf(t,tf.SKY);let n=new ma(28,34,54,68);n.rotateX(-Math.PI/2);let r=n.attributes.position,i=new Float32Array(r.count*3),a=new K(10118948),o=new K(13802037);for(let e=0;e<r.count;e+=1){let t=r.getX(e),n=r.getZ(e),s=Math.sin(t*.48+n*.16)*.18+Math.sin(n*.41)*.11;r.setY(e,s-.25);let c=.5+.5*Math.sin(t*.72-n*.32),l=a.clone().lerp(o,c*.72+.14);i[e*3]=l.r,i[e*3+1]=l.g,i[e*3+2]=l.b}n.setAttribute(`color`,new _r(i,3)),n.computeVertexNormals();let s=new ii(n,new Oa({vertexColors:!0,roughness:.9,metalness:0,side:2}));s.position.z=-4,Vf(s,tf.GROUND),[[-6.2,2.2,-11.8,5.2,7.6,5271419],[-1.5,2.7,-12.8,6.8,8.7,6916226],[4.7,2,-12.1,5.3,7.2,5535361],[8.8,1.45,-11.7,4.1,6.4,7572347]].forEach(([e,t,n,r,i,a],o)=>{let s=new ii(new pa(r,i,7,3,!1,o*.31),new Oa({color:a,roughness:.96,flatShading:!0}));s.position.set(e,t,n),s.scale.z=.48,Vf(s,tf.MOUNTAIN)});function c(e,t,n=1){let r=new kn,i=new Oa({color:2182463,roughness:.95});for(let e=0;e<4;e+=1){let t=new ii(new pa((.52-e*.07)*n,2.15*n,9),i);t.position.y=(.78+e*.66)*n,t.rotation.y=e*.47,r.add(t)}let a=new ii(new fa(.11*n,.19*n,1.7*n,7),new Oa({color:5849119,roughness:1}));a.position.y=.45*n,r.add(a),r.position.set(e,-.1,t),r.userData.semantic=tf.VEGETATION,r.traverse(e=>{e.isMesh&&(e.userData.semantic=tf.VEGETATION,zf.push(e))}),af.add(r)}c(-5,-6.7,1.65),c(5.6,-7.3,1.2),c(7.3,-8.3,.78);function l(e,t,n,r,i){let a=new ii(new ua(1.65*n,1.15*n,1.35*n),new Oa({color:r,roughness:.92}));a.position.set(e,.42*n,t),Vf(a,tf.BUILDING);let o=new ii(new pa(1.28*n,.82*n,4),new Oa({color:i,roughness:.95}));o.position.set(e,1.35*n,t),o.rotation.y=Math.PI*.25,o.scale.z=.78,Vf(o,tf.BUILDING);let s=new Kr({color:4021888});for(let r of[-.42,.42]){let i=new ii(new ma(.25*n,.38*n),s);i.position.set(e+r*n,.48*n,t+.681*n),Vf(i,tf.BUILDING)}}l(2.5,-5.6,1.15,14073996,9194806),l(4.5,-6.5,.72,13146983,7289652);let u=new Oa({color:14724677,roughness:.94}),d=new Ai(new pa(.035,.62,4),u,520),f=new G,p=new H,m=new Nt,h=new H;for(let e=0;e<d.count;e+=1){let t=(hm(e*3.17)-.5)*19,n=-1.8-hm(e*8.91+4.2)*8.4;p.set(t,-.02,n),m.setFromEuler(new dn((hm(e+7)-.5)*.18,hm(e+2)*Math.PI,0));let r=.66+hm(e*1.77)*.8;h.set(r,r,r),f.compose(p,m,h),d.setMatrixAt(e,f)}d.instanceMatrix.needsUpdate=!0,Vf(d,tf.GROUND)}Hf();var Uf=af.children.filter(e=>e!==If&&e!==Lf);lf.addEventListener(`start`,()=>{wf&&(Mf=!0,Uu.classList.add(`is-orbiting`),Np=!0,Y.textContent=X.liveModelAnalysis?`正在调整模型角度 · 笔触实时跟随`:`正在调整模型角度 · 流畅 3D 预览`,nm())}),lf.addEventListener(`change`,()=>{wf&&(jf=!0,Sp=!0,Np=!0,document.documentElement.dataset.modelView=[sf.position.x.toFixed(3),sf.position.y.toFixed(3),sf.position.z.toFixed(3)].join(`,`),nm())}),lf.addEventListener(`end`,()=>{if(!wf)return;let e=jf&&!X.liveModelAnalysis&&X.viewMode!==3;Mf=!1,Uu.classList.remove(`is-orbiting`),jf&&(yp=!0),e&&zh(),Np=!0,Y.textContent=e?`模型角度已同步 · 新笔触正在生长`:`模型角度已同步 · 笔触正在定稿`,nm()});var Wf=new Ea({side:2,blending:0,vertexShader:`
  ...
  `}),Gf=Object.fromEntries(Object.keys(nf).map(e=>[e,new Ea({side:2,blending:0,uniforms:{uId:{value:Number(e)/255}},vertexShader:`
      void main() {
        vec4 localPosition = vec4(position, 1.0);
        #ifdef USE_INSTANCING
          localPosition = instanceMatrix * localPosition;
    ...
    `,fragmentShader:`uniform float uId; void main(){gl_FragColor=vec4(uId,0.0,0.0,1.0);}`})])),Kf=new Rn,qf=new Do(-1,1,1,-1,0,1),Jf=new Rn,Yf=new Do(-1,1,1,-1,0,1),Xf=`
  attribute vec2 aP0;
  attribute vec2 aP1;
  attribute vec2 aP2;
  attribute vec2 aP3;
...
`,$f=new Ea({transparent:!0,depthTest:!1,depthWrite:!1,side:2,vertexShader:Xf,fragmentShader:Zf,uniforms:{uResolution:{value:new V(1,1)},uStrokeScale:{value:1},uBrushSize:{value:X.strokeSize},uCoverage:{value:X.coverage},uWetness:{value:ef()},uViscosity:{value:X.viscosity},uBristleDetail:{value:X.bristleDetail},uGrowthTime:{value:0},uGrowthEnabled:{value:1},uSceneMorph:{value:1},uBrushLayerVisibility:{value:new H(1,1,1)}}}),ep=new Ea({transparent:!0,depthTest:!1,depthWrite:!1,side:2,vertexShader:Xf,fragmentShader:`
  uniform float uCoverage;
  varying vec3 vColor;
  varying float vSide;
  varying float vT;
...
`,uniforms:{uResolution:{value:new V(1,1)},uStrokeScale:{value:.34},uBrushSize:{value:X.strokeSize},uCoverage:{value:X.coverage},uGrowthTime:{value:0},uGrowthEnabled:{value:1},uSceneMorph:{value:1},uBrushLayerVisibility:{value:new H(1,1,1)}}}),tp=new Ea({transparent:!0,depthTest:!1,depthWrite:!1,side:2,blending:2,vertexShader:Xf,fragmentShader:Qf,uniforms:{uResolution:{value:new V(1,1)},uStrokeScale:{value:1},uBrushSize:{value:X.strokeSize},uCoverage:{value:X.coverage},uWetness:{value:ef()},uViscosity:{value:X.viscosity},uBristleDetail:{value:X.bristleDetail},uGrowthTime:{value:0},uGrowthEnabled:{value:1},uSceneMorph:{value:1},uBrushLayerVisibility:{value:new H(1,1,1)}}}),np=new Ea({depthTest:!1,depthWrite:!1,uniforms:{uScene:{value:null},uStroke:{value:null},uHeight:{value:null},uSemantic:{value:null},uTexel:{value:new V(1,1)},uMode:{value:0},uImpasto:{value:X.impasto},uWetness:{value:ef()},uLightAngle:{value:0},uTime:{value:0}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
  ...
  `}),rp=new ii(new ma(2,2),np);Jf.add(rp);var ip,ap,op,sp,cp,lp,up,Q,dp=null,fp=[],pp=0,mp=0,hp=0,gp=0,$=0,_p=0,vp=null,yp=!0,bp=!1,xp=!0,Sp=!0,Cp=-1/0,wp=0,Tp=0,Ep=0,Dp=0,Op=0,kp=0,Ap=0,jp=0,Mp=!0,Np=!0,Pp=!1,Fp=!1,Ip=0,Lp=0,Rp=!1,zp=0,Bp=5,Vp=1800,Hp=6200,Up=30,Wp=24,Gp=8e3,Kp=6e6,qp=900,Jp=180,Yp=.982,Xp=1,Zp=new V(0,0),Qp=new H,$p=10,em=new Float32Array(20),tm=new Float32Array(20);function nm(){Tp||=(wp||=performance.now(),requestAnimationFrame(Ym))}var rm=Object.freeze({balanced:Object.freeze({renderScale:.7,smallScale:.88,analysisEdge:340,samples:0}),high:Object.freeze({renderScale:1,smallScale:1,analysisEdge:460,samples:4}),ultra:Object.freeze({renderScale:1.25,smallScale:1.18,analysisEdge:580,samples:4})});function im(e,t,n={}){let r=new Qt(e,t,{minFilter:n.nearest?o:l,magFilter:n.nearest?o:l,format:D,type:f,depthBuffer:n.depth!==!1,stencilBuffer:!1});return r.samples=Z.capabilities.isWebGL2&&n.samples||0,r.texture.colorSpace=``,r}function am(){[ip,ap,op,sp,cp,lp].forEach(e=>e?.dispose())}function om(){let e=getComputedStyle(vd),t=getComputedStyle(Uu),n=Math.max(2,vd.clientWidth-parseFloat(e.paddingLeft)-parseFloat(e.paddingRight)),r=Math.max(2,vd.clientHeight-parseFloat(e.paddingTop)-parseFloat(e.paddingBottom)),i=parseFloat(t.borderLeftWidth)+parseFloat(t.borderRightWidth),a=parseFloat(t.borderTopWidth)+parseFloat(t.borderBottomWidth);if(wf){let e=Math.max(2,n-i),t=Math.max(2,r-a);Uu.style.width=`${Math.round(e+i)}px`,Uu.style.height=`${Math.round(t+a)}px`,document.documentElement.dataset.canvasAspect=(e/t).toFixed(4),document.documentElement.dataset.canvasFit=`model-area`;return}let o=mf?mf.width/Math.max(1,mf.height):16/10,s=Math.max(2,n-i),c=s/o;c+a>r&&(c=Math.max(2,r-a),s=c*o),Uu.style.width=`${Math.round(s+i)}px`,Uu.style.height=`${Math.round(c+a)}px`,document.documentElement.dataset.canvasAspect=o.toFixed(4),document.documentElement.dataset.canvasFit=`source-aspect`}function sm(){if(!xp&&pp>0&&mp>0)return!1;om();let e=Math.max(2,Math.floor(Uu.clientWidth)),t=Math.max(2,Math.floor(Uu.clientHeight)),n=e/t,r=rm[X.qualityMode]||rm.high,i=e*t>42e4?r.renderScale:r.smallScale,a=Math.max(2,Math.round(e*i)),o=Math.max(2,Math.round(t*i)),s,c;n>=1?(s=Math.min(r.analysisEdge,Math.max(300,Math.round(e*.46))),c=Math.max(144,Math.round(s/n))):(c=Math.min(r.analysisEdge,Math.max(300,Math.round(t*.4))),s=Math.max(144,Math.round(c*n)));let l=Z.capabilities.isWebGL2?r.samples:0,u=!!(ip&&pp===e&&mp===t&&hp===a&&gp===o&&$===s&&_p===c&&ip.samples===l&&cp?.samples===l&&lp?.samples===l);return xp=!1,!u&&(pp=e,mp=t,hp=a,gp=o,$=s,_p=c,Z.setSize(hp,gp,!1),sf.aspect=e/t,sf.updateProjectionMatrix(),am(),ip=im(hp,gp,{samples:r.samples}),ap=im($,_p),op=im($,_p,{nearest:!0}),sp=im($,_p,{nearest:!0}),cp=im(hp,gp,{depth:!1,samples:r.samples}),lp=im(hp,gp,{depth:!1,samples:r.samples}),vp={color:new Uint8Array($*_p*4),normalDepth:new Uint8Array($*_p*4),semantic:new Uint8Array($*_p*4)},np.uniforms.uScene.value=ip.texture,np.uniforms.uStroke.value=cp.texture,np.uniforms.uHeight.value=lp.texture,np.uniforms.uSemantic.value=sp.texture,np.uniforms.uTexel.value.set(1/hp,1/gp),$f.uniforms.uResolution.value.set(hp,gp),$f.uniforms.uStrokeScale.value=hp/pp*1.12,ep.uniforms.uResolution.value.set(hp,gp),ep.uniforms.uStrokeScale.value=hp/pp*.34,tp.uniforms.uResolution.value.set(hp,gp),tp.uniforms.uStrokeScale.value=hp/pp*1.12,Ju.textContent=`${$} × ${_p}`,$u.textContent=`${Z.capabilities.isWebGL2?`WebGL2`:`WebGL`} · ${X.qualityMode} · ${Math.round(i*100)}%`,document.documentElement.dataset.outputSize=`${pp}x${mp}`,document.documentElement.dataset.renderSize=`${hp}x${gp}`,document.documentElement.dataset.sceneTargetSize=`${ip.width}x${ip.height}`,yp=!0,Sp=!0,fp=[],!0)}function cm(e,t=mf){let n=e.width/Math.max(1,e.height),r=t.width/Math.max(1,t.height);r>=n?ff.uniforms.uScale.value.set(1,n/r):ff.uniforms.uScale.value.set(r/n,1),ff.uniforms.uScale.value.multiplyScalar(Yp)}function lm(e,t=0,n=mf,r=hf){cm(e,n),ff.uniforms.uImage.value=r,ff.uniforms.uPass.value=t,Z.setRenderTarget(e),Z.setViewport(0,0,e.width,e.height),t===1?Z.setClearColor(0,1):t===2?Z.setClearColor(8421631,1):Z.setClearColor(15063749,1),Z.clear(!0,!0,!0),Z.render(uf,df)}function um(e){if(mf){lm(e,0,mf,hf);return}Z.setRenderTarget(e),Z.setClearColor(wf?14210250:725794,1),Z.clear(!0,!0,!0),Z.render(af,sf)}function dm(){let e=[];zf.forEach(t=>{e.push([t,t.material]),t.material=Gf[t.userData.semantic]||Gf[tf.SKY]}),Z.setRenderTarget(sp),Z.setClearColor(0,1),Z.clear(!0,!0,!0),Z.render(af,sf),e.forEach(([e,t])=>{e.material=t})}function fm(){mf?(lm(ap,0,mf,hf),lm(op,2,mf,hf),lm(sp,1,mf,hf)):(um(ap),af.overrideMaterial=Wf,Z.setRenderTarget(op),Z.setClearColor(8421631,1),Z.clear(!0,!0,!0),Z.render(af,sf),af.overrideMaterial=null,dm()),Z.readRenderTargetPixels(ap,0,0,$,_p,vp.color),Z.readRenderTargetPixels(op,0,0,$,_p,vp.normalDepth),Z.readRenderTargetPixels(sp,0,0,$,_p,vp.semantic)}function pm(e,t){let n=Math.max(0,Math.min($-1,Math.round(e))),r=Math.max(0,Math.min(_p-1,Math.round(t)));return Math.round(vp.semantic[(r*$+n)*4]||0)}function mm(e,t){let n=Math.max(0,Math.min($-1,Math.round(e))),r=Math.max(0,Math.min(_p-1,Math.round(t)));return vp.normalDepth[(r*$+n)*4+3]/255}function hm(e){return gm(Math.sin(e*91.173+17.371)*43758.5453)}function gm(e){return e-Math.floor(e)}function _m(e,t,n,r,i,a){let o=Math.cos(e*2)*t+Math.cos(n*2)*r+Math.cos(i*2)*a,s=Math.sin(e*2)*t+Math.sin(n*2)*r+Math.sin(i*2)*a;return Math.atan2(s,o)*.5}function vm(){let e=$*_p,t=new Float32Array(e),n=new Float32Array(e),r=new Float32Array(e),i=new Float32Array(e),a=new Float32Array(e),o=new Float32Array(e),s=new Float32Array(e),c=!!mf;for(let n=0;n<e;n+=1){let e=n*4;t[n]=(vp.color[e]*.2126+vp.color[e+1]*.7152+vp.color[e+2]*.0722)/255}let l=(e,t,n)=>e[Math.max(0,Math.min(_p-1,n))*$+Math.max(0,Math.min($-1,t))];for(let e=0;e<_p;e+=1)for(let o=0;o<$;o+=1){let s=e*$+o;n[s]=l(t,o+1,e)-l(t,o-1,e),r[s]=l(t,o,e+1)-l(t,o,e-1),i[s]=mm(o+1,e)-mm(o-1,e),a[s]=mm(o,e+1)-mm(o,e-1)}let u=new Float32Array(e),d=new Float32Array(e),f=new Float32Array(e);for(let t=0;t<e;t+=1)u[t]=n[t]*n[t],d[t]=r[t]*r[t],f[t]=n[t]*r[t];let p=$+1,m=e=>{let t=new Float32Array(($+1)*(_p+1));for(let n=0;n<_p;n+=1){let r=0;for(let i=0;i<$;i+=1)r+=e[n*$+i],t[(n+1)*p+i+1]=t[n*p+i+1]+r}return t},h=m(u),g=m(d),_=m(f),v=(e,t,n,r,i)=>e[i*p+r]-e[n*p+r]-e[i*p+t]+e[n*p+t];for(let e=0;e<_p;e+=1)for(let t=0;t<$;t+=1){let n=e*$+t,r=Math.max(0,t-2),l=Math.max(0,e-2),u=Math.min($,t+2+1),d=Math.min(_p,e+2+1),f=v(h,r,l,u,d),p=v(g,r,l,u,d),m=v(_,r,l,u,d),y=f+p,b=Math.sqrt(Math.max(0,(f-p)**2+4*m*m)),x=Math.min(1,b/(y+8e-4)),S=.5*Math.atan2(2*m,f-p)+Math.PI*.5,C=n*4,w=pm(t,e);if(!w){o[n]=0,s[n]=0;continue}let T=vp.normalDepth[C]/127.5-1,E=vp.normalDepth[C+1]/127.5-1,D=_m(Math.atan2(T,-E),.55,Math.atan2(i[n],-a[n]),Math.min(.9,Math.hypot(i[n],a[n])*80),0,0),O=t/Math.max(1,$-1),k=e/Math.max(1,_p-1),A=0;if(c){let e=S+Math.sin(O*17+k*23)*.075,t=Math.atan2((k-.5)*1.18,O-.5)+Math.PI*.5+Math.sin(O*13-k*9)*.12;o[n]=_m(S,X.structure*(.35+x*1.15),e,X.geometry*(.12+x*.72),t,X.semantic*(.08+(1-x)*.34)),s[n]=Math.min(1,.18+x*.72)}else if(w===tf.SKY){let e=O-.31,t=(k-.59)*1.25;A=Math.atan2(t,e)+Math.PI*.5+Math.sin(O*14+k*9)*.13}else w===tf.MOUNTAIN?A=(O<.5?.56:Math.PI-.56)+Math.sin(k*13)*.11:w===tf.GROUND?A=Math.atan2(k-.54,O-.53)+Math.sin(O*18-k*8)*.08:w===tf.VEGETATION?A=Math.PI*.5+Math.sin(k*18+O*9)*.26:w===tf.BUILDING?A=x>.28?S:hm(Math.floor(O*28)+Math.floor(k*22)*5)>.52?0:Math.PI*.5:w===tf.IMAGE&&(A=_m(S,.62,D,.92,0,0));c||(o[n]=_m(S,X.structure*(.18+x*.82),D,X.geometry,A,X.semantic),s[n]=Math.min(1,.24+x*.52+Math.hypot(i[n],a[n])*12))}dp={angle:o,confidence:s,luminance:t}}function ym(e,t,n,r){let i=n/Math.SQRT2,a=Math.ceil($/i),o=Math.ceil(_p/i),s=new Int32Array(a*o).fill(-1),c=[],l=t*34,u=kp*104729+e*9176;for(let d=0;d<l&&c.length<t;d+=1){let t=d+u+1,l=gm(.5+t*.754877666)*$,f=gm(.5+t*.569840296)*_p,p=pm(l,f);if(!p||mm(l,f)>=.999)continue;let m=Math.min(dp.angle.length-1,Math.floor(f)*$+Math.floor(l)),h=dp.confidence[m],g=p===tf.VEGETATION?1:p===tf.BUILDING?.72:.88;if(hm(t*2.13)>g*(.64+h*.36))continue;let _=Math.floor(l/i),v=Math.floor(f/i),y=!0;for(let e=-2;e<=2&&y;e+=1)for(let t=-2;t<=2;t+=1){let r=_+t,i=v+e;if(r<0||i<0||r>=a||i>=o)continue;let u=s[i*a+r];if(u<0)continue;let d=c[u];if(Math.hypot(d.x-l,d.y-f)<n){y=!1;break}}if(!y)continue;let b=mm(l,f),x={x:l,y:f,world:new H(l/$*2-1,f/_p*2-1,b*2-1).unproject(sf),semantic:p,layer:e,depth:b,random:hm(t*7.31+e*13.7)};s[v*a+_]=c.length,c.push(x),r.push(x)}}function bm(e={}){let t=e.preserveGrowth?Lm():0,n=[],r=Math.max(3e3,Math.min(24e3,Math.round(X.strokeCountK*1e3))),i=Math.round(r*.06),a=Math.round(r*.225),o=r-i-a,s=Math.sqrt($*_p/143520)*Math.sqrt(14e3/r);[[0,i,5.8*s],[1,a,2.75*s],[2,o,1.2*s]].forEach(([e,t,r])=>{ym(e,t,r,n)}),fp=n,fp.forEach(e=>{e.color=Tm(e,e.x,e.y)}),kp+=1,jp=Ap-t*1e3,Mp=!0,Yu.textContent=`0.0%`,qu.textContent=`${fp.length.toLocaleString()} 笔触`;let c=document.querySelector(`[data-output="strokeCountK"]`);c&&(c.textContent=fp.length.toLocaleString())}function xm(e,t){let n=Math.max(0,Math.min($-1,Math.round(e))),r=Math.max(0,Math.min(_p-1,Math.round(t)));return dp.angle[r*$+n]}function Sm(e,t,n,r){let i=wm(e,t),a=wm(n,r),o=(vp.color[i]-vp.color[a])/255,s=(vp.color[i+1]-vp.color[a+1])/255,c=(vp.color[i+2]-vp.color[a+2])/255;return Math.sqrt(o*o*.24+s*s*.56+c*c*.2)}function Cm(e,t,n,r,i,a,o){let s=mm(t,n),c=t,l=n,u=0,d=0,f=0,p=i/a;for(let i=0;i<a;i+=1){let a=xm(c,l),m=Math.cos(a)*r,h=Math.sin(a)*r;i>0&&m*u+h*d<0&&(m*=-1,h*=-1),a=xm(c+m*p*.5,l+h*p*.5);let g=Math.cos(a)*r,_=Math.sin(a)*r;g*m+_*h<0&&(g*=-1,_*=-1);let v=c+g*p,y=l+_*p;if(v<1||y<1||v>=$-1||y>=_p-1||pm(v,y)!==e.semantic||Math.abs(mm(v,y)-s)>.075||(mf||wf)&&Sm(t,n,v,y)>.31)break;c=v,l=y,u=g,d=_,o[f*2]=c,o[f*2+1]=l,f+=1}return f}function wm(e,t){let n=Math.max(0,Math.min($-1,Math.round(e)));return(Math.max(0,Math.min(_p-1,Math.round(t)))*$+n)*4}function Tm(e,t,n){let r=wm(t,n);if(mf||wf){let i=[3.2,1.45,.45][e.layer],a=wm(t-i,n),o=wm(t+i,n),s=wm(t,n-i),c=wm(t,n+i),l=new K((vp.color[r]+vp.color[a]+vp.color[o]+vp.color[s]+vp.color[c])/1275,(vp.color[r+1]+vp.color[a+1]+vp.color[o+1]+vp.color[s+1]+vp.color[c+1])/1275,(vp.color[r+2]+vp.color[a+2]+vp.color[o+2]+vp.color[s+2]+vp.color[c+2])/1275);return l.offsetHSL((e.random-.5)*.018,.035+e.layer*.018,(e.random-.5)*.055),l}let i=rf[e.semantic]||rf[tf.SKY],a=(vp.color[r]*.2126+vp.color[r+1]*.7152+vp.color[r+2]*.0722)/255;return new K(i[Math.max(0,Math.min(i.length-1,Math.floor(a*i.length+(e.random-.5)*1.5)))])}function Em(){let e=[],t=[];for(let t=0;t<=8;t+=1){let n=t/8;e.push(n,-1,0,n,1,0)}for(let e=0;e<8;e+=1){let n=e*2;t.push(n,n+1,n+2,n+1,n+3,n+2)}let n=new jo;return n.setAttribute(`position`,new br(e,3)),n.setIndex(t),n}function Dm(e){if(Q?.userData.capacity===e)return;Q?.dispose(),up&&Kf.remove(up),Q=Em(),Q.userData.capacity=e;let t=(e,t)=>{let n=new Si(new Float32Array(e),t);return n.setUsage(Je),n};Q.setAttribute(`aP0`,t(e*2,2)),Q.setAttribute(`aP1`,t(e*2,2)),Q.setAttribute(`aP2`,t(e*2,2)),Q.setAttribute(`aP3`,t(e*2,2)),Q.setAttribute(`aColor`,t(e*3,3)),Q.setAttribute(`aWidth`,t(e,1)),Q.setAttribute(`aSeed`,t(e,1)),Q.setAttribute(`aPrevP01`,t(e*4,4)),Q.setAttribute(`aPrevP23`,t(e*4,4)),Q.setAttribute(`aBirth`,t(e,1)),Q.setAttribute(`aDuration`,t(e,1)),Q.setAttribute(`aBrushLayer`,t(e,1)),Q.instanceCount=e,up=new ii(Q,$f),up.frustumCulled=!1,Kf.add(up)}var Om=Object.freeze([`aP0`,`aP1`,`aP2`,`aP3`]);function km(e){let t=Mt.clamp(e,0,1);[$f,ep,tp].forEach(e=>{e.uniforms.uSceneMorph.value=t}),document.documentElement.dataset.strokeMorphProgress=t.toFixed(3)}function Am(){if(!Q||Q.instanceCount<1)return null;let e=$f.uniforms.uSceneMorph.value,t=Q.getAttribute(`aPrevP01`).array,n=Q.getAttribute(`aPrevP23`).array,r={};return Om.forEach((i,a)=>{let o=Q.getAttribute(i).array,s=new Float32Array(o.length);if(Rp&&e<.999){let r=a<2?t:n,i=a%2==0?0:2;for(let t=0;t<Q.instanceCount;t+=1){let n=t*2,a=t*4+i;s[n]=Mt.lerp(r[a],o[n],e),s[n+1]=Mt.lerp(r[a+1],o[n+1],e)}}else s.set(o);r[i]=s}),{count:Q.instanceCount,attributes:r}}function jm(e){if(!e||!Q||!e.count)return!1;let t=Q.instanceCount,n=Q.getAttribute(`aPrevP01`),r=Q.getAttribute(`aPrevP23`),i=n.array,a=r.array;for(let n=0;n<t;n+=1){let r=Math.min(e.count-1,Math.floor(n*e.count/t))*2,o=n*4;i[o]=e.attributes.aP0[r],i[o+1]=e.attributes.aP0[r+1],i[o+2]=e.attributes.aP1[r],i[o+3]=e.attributes.aP1[r+1],a[o]=e.attributes.aP2[r],a[o+1]=e.attributes.aP2[r+1],a[o+2]=e.attributes.aP3[r],a[o+3]=e.attributes.aP3[r+1]}return n.needsUpdate=!0,r.needsUpdate=!0,X.growthPlayback=!1,Pp=!1,Rp=!0,zp=performance.now(),km(0),zm(Bp),document.documentElement.dataset.strokeMorphState=`morphing`,Y.textContent=`作品切换中 · 笔触正在变形`,Fm(),Mp=!0,Np=!0,nm(),!0}function Mm(e){if(!Rp)return!1;let t=Mt.clamp((e-zp)/Vp,0,1);return km(t*t*(3-2*t)),Mp=!0,Np=!0,t>=1&&(Rp=!1,document.documentElement.dataset.strokeMorphState=`idle`,Y.textContent=`作品切换完成 · 笔触身份已稳定`,Fm()),Rp}function Nm(){let e=performance.now(),t=fp.length;Dm(t);let n=Q.getAttribute(`aP0`).array,r=Q.getAttribute(`aP1`).array,i=Q.getAttribute(`aP2`).array,a=Q.getAttribute(`aP3`).array,o=Q.getAttribute(`aColor`).array,s=Q.getAttribute(`aWidth`).array,c=Q.getAttribute(`aSeed`).array,l=Q.getAttribute(`aBirth`).array,u=Q.getAttribute(`aDuration`).array,d=Q.getAttribute(`aBrushLayer`).array,f=0;for(let e=0;e<t;e+=1){let t=fp[e],p=Qp.copy(t.world).project(sf),m=(p.x*.5+.5)*$,h=(p.y*.5+.5)*_p,g=p.z>-1&&p.z<1&&m>=1&&h>=1&&m<$-1&&h<_p-1&&pm(m,h)===t.semantic,_=[25,14,7.4][t.layer]*X.length*(.82+t.random*.36),v=g?Cm(t,m,h,-1,_*.5,$p,em):0,y=g?Cm(t,m,h,1,_*.5,$p,tm):0,b=Math.max(0,v-1)*2,x=Math.floor(v*.48)*2,S=Math.floor(y*.48)*2,C=Math.max(0,y-1)*2,w=e*2;n[w]=(v?em[b]:m)/$,n[w+1]=(v?em[b+1]:h)/_p,r[w]=(v?em[x]:m)/$,r[w+1]=(v?em[x+1]:h)/_p,i[w]=(y?tm[S]:m)/$,i[w+1]=(y?tm[S+1]:h)/_p,a[w]=(y?tm[C]:m)/$,a[w+1]=(y?tm[C+1]:h)/_p;let T=t.color||Tm(t,m,h);if(o[e*3]=T.r,o[e*3+1]=T.g,o[e*3+2]=T.b,s[e]=g?[11.5,6,3.15][t.layer]*(.82+t.random*.36):0,c[e]=t.random+e*13e-5,d[e]=t.layer,t.layer===2){let n=hm(t.x*.137+t.y*.193+t.random*17.1);l[e]=.72+n*1.85,u[e]=.22+t.random*.18}else l[e]=[0,.72][t.layer]+t.random*[.7,1.2][t.layer],u[e]=[1.2,.9][t.layer]*(.82+t.random*.36);g&&(f+=1)}[`aP0`,`aP1`,`aP2`,`aP3`,`aColor`,`aWidth`,`aSeed`,`aBirth`,`aDuration`,`aBrushLayer`].forEach(e=>{Q.getAttribute(e).needsUpdate=!0}),Mp=!0,bp=!1;let p=performance.now()-e;document.documentElement.dataset.strokeGeometryMs=p.toFixed(2),Yu.textContent=`${((1-f/Math.max(1,t))*100).toFixed(1)}% occluded`}function Pm(e=!1){let t=performance.now();fm(),vm();let n=!!(wf&&jf&&fp.length>0);(e||fp.length===0||n)&&bm({preserveGrowth:n}),Nm(),Ip=performance.now()-t,Zu.textContent=`${Ip.toFixed(1)} ms`,yp=!1,jf=!1,Cp=performance.now(),Y.textContent=wf&&X.liveModelAnalysis&&(Mf||Nf)?Nf?`环境光调整中 · 笔触实时跟随`:`拖动中 · 笔触实时跟随`:mf?`原图已转换 · 方向场与颜色已同步`:`实时运行 · 方向场已同步`,Fm()}function Fm(){let e=Th();window.__vangoghFlowState={ready:!0,sourceMode:wf?`model`:mf?`image`:`scene`,activeSceneId:yf||null,sceneSwitchMs:Number(document.documentElement.dataset.sceneSwitchMs||0),sceneTransition:{active:Rp,progress:Number(document.documentElement.dataset.strokeMorphProgress||1),autoTour:Sf},sourceSize:mf?[mf.width,mf.height]:null,model:Df?{...Df}:null,modelAppearance:wf?{color:kf||null,lightAngle:X.modelLightAngle,liveStrokeFollow:X.liveModelAnalysis}:null,strokes:fp.length,gbuffer:[$,_p],layers:3,brushLayers:[...X.brushLayers],strokeMaterial:{size:X.strokeSize,dryness:X.dryness,viscosity:X.viscosity,impasto:X.impasto},persistentSeeds:!0,performance:{fieldMs:Ip,geometryMs:Number(document.documentElement.dataset.strokeGeometryMs||0),reseedMs:Lp},videoExport:{supported:!!(e&&typeof Z.domElement.captureStream==`function`),recording:Fp,format:e?.extension||null,preflightFps:Number(document.documentElement.dataset.videoPreflightFps||0),lastBytes:Number(document.documentElement.dataset.lastVideoBytes||0)},errors:window.__vangoghFlowErrors},document.documentElement.dataset.flowReady=`true`,document.documentElement.dataset.strokeCount=String(fp.length),document.documentElement.dataset.fieldUpdateMs=Ip.toFixed(2)}function Im(){if(!dp){Pm(!0);return}let e=performance.now();bm(),Nm(),Lp=performance.now()-e,document.documentElement.dataset.reseedMs=Lp.toFixed(2),Zu.textContent=`${Lp.toFixed(1)} ms`,Fm()}function Lm(){return X.growthPlayback?Math.max(0,Math.min(Bp,(Ap-jp)/1e3)):Bp}function Rm(e){return`00:${e.toFixed(1).padStart(4,`0`)}`}function zm(e=Lm()){let t=Math.max(0,Math.min(Bp,e)),n=t/Bp;jd.value=t.toFixed(2),jd.style.setProperty(`--timeline-progress`,`${(n*100).toFixed(2)}%`),Md.textContent=`${Rm(t)} / ${Rm(Bp)}`,document.documentElement.dataset.growthTime=t.toFixed(2)}function Bm(e){let t=Math.max(0,Math.min(Bp,Number(e)||0));X.growthPlayback=!0,Ap=jp+t*1e3,Pp=t<Bp,Mp=!0,Np=!0,zm(t),nm()}function Vm(){if(!up)return!1;let e=Lm(),t=X.growthPlayback&&e<Bp;if(Pp&&!t&&(Mp=!0),Pp=t,!Mp&&(!t||X.paused))return!1;let n=X.growthPlayback?Math.min(1,e/Bp):1;Qu.textContent=n>=1?Id(`growthComplete`):`${Math.round(n*100)}% · ${Id(e<1.4?`growthCoarse`:e<3.2?`growthMediumFine`:`growthFinishing`)}`,n>=1&&Y.textContent.startsWith(`正在生长`)&&(Y.textContent=`生长完成 · 笔触身份保持`),zm(e),document.documentElement.dataset.growthProgress=n.toFixed(3),$f.uniforms.uCoverage.value=X.coverage,ep.uniforms.uCoverage.value=X.coverage,tp.uniforms.uCoverage.value=X.coverage,$f.uniforms.uBrushSize.value=X.strokeSize,ep.uniforms.uBrushSize.value=X.strokeSize,tp.uniforms.uBrushSize.value=X.strokeSize,$f.uniforms.uWetness.value=ef(),tp.uniforms.uWetness.value=ef(),$f.uniforms.uViscosity.value=X.viscosity,tp.uniforms.uViscosity.value=X.viscosity,$f.uniforms.uBristleDetail.value=X.bristleDetail,tp.uniforms.uBristleDetail.value=X.bristleDetail,$f.uniforms.uGrowthTime.value=e,ep.uniforms.uGrowthTime.value=e,tp.uniforms.uGrowthTime.value=e,$f.uniforms.uGrowthEnabled.value=+!!X.growthPlayback,ep.uniforms.uGrowthEnabled.value=+!!X.growthPlayback,tp.uniforms.uGrowthEnabled.value=+!!X.growthPlayback;let r=X.viewMode===1;return up.material=r?ep:$f,Z.setRenderTarget(cp),Z.setViewport(0,0,cp.width,cp.height),Z.setClearColor(0,0),Z.clear(!0,!0,!0),Z.render(Kf,qf),r||(up.material=tp,Z.setRenderTarget(lp),Z.setViewport(0,0,lp.width,lp.height),Z.setClearColor(0,0),Z.clear(!0,!0,!0),Z.render(Kf,qf)),up.material=r?ep:$f,Mp=!1,!0}function Hm(e){np.uniforms.uMode.value=Mf&&!X.liveModelAnalysis||X.showBase?3:X.viewMode,np.uniforms.uImpasto.value=X.impasto,np.uniforms.uWetness.value=ef(),np.uniforms.uLightAngle.value=X.movingLight?e*22e-5:-.8,np.uniforms.uTime.value=e*.001,Z.setRenderTarget(null),Z.setViewport(0,0,hp,gp),document.documentElement.dataset.compositeViewport=`${hp}x${gp}`,Z.setClearColor(725794,1),Z.clear(!0,!0,!0),Z.render(Jf,Yf),Np=!1}function Um(e,t=null){let n=Math.max(1,Math.min(4,e));if(n<=1.0001)Xp=1,Zp.set(0,0);else{let e=vd.getBoundingClientRect(),r=e.left+Uu.offsetLeft,i=e.top+Uu.offsetTop,a=t?.x??r+Uu.offsetWidth*.5,o=t?.y??i+Uu.offsetHeight*.5,s=(a-r-Zp.x)/Xp,c=(o-i-Zp.y)/Xp;Zp.set(a-r-s*n,o-i-c*n),Xp=n}Uu.style.setProperty(`--canvas-zoom`,Xp.toFixed(4)),Uu.style.setProperty(`--canvas-pan-x`,`${Zp.x.toFixed(2)}px`),Uu.style.setProperty(`--canvas-pan-y`,`${Zp.y.toFixed(2)}px`),Uu.classList.toggle(`is-zoomed`,Xp>1.0001),document.documentElement.dataset.canvasZoom=Xp.toFixed(2)}function Wm(){Um(1)}function Gm(){wf&&(lf.reset(),lf.update(),yp=!0,Sp=!0,Np=!0,Y.textContent=`模型视角已复位 · 笔触重新同步`,nm())}function Km(e){if(wf)return;e.preventDefault();let t=Uu.getBoundingClientRect(),n=e.deltaY*(e.deltaMode===1?16:e.deltaMode===2?t.height:1);Um(Xp*Math.exp(-n*.0014),{x:e.clientX,y:e.clientY})}function qm(){wf?Gm():Wm()}function Jm(e){if(wf||!X.cameraDrift||X.paused)return;let t=e*16e-5;sf.position.x=Math.sin(t)*.58,sf.position.y=4.8+Math.sin(t*.63)*.12,sf.position.z=10.5+Math.cos(t)*.16,sf.lookAt(cf)}function Ym(e){Tp=0;let t=Math.max(0,e-wp),n=Math.min(64,t);wp=e,X.paused||(Op+=n,Ap+=t),Ep+=n,Dp+=1,Ep>600&&(Xu.textContent=`${Math.round(Dp*1e3/Ep)} fps`,Ep=0,Dp=0),sm()&&(Np=!0),Jm(Op),Bf.uniforms.uTime.value=Op*.001;let r=!1;(Sp||X.cameraDrift)&&(um(ip),Sp=!1,r=!0);let i=X.liveModelAnalysis&&wf&&(Mf||Nf)&&jf,a=i&&e-Cp>Jp;yp||a||X.cameraDrift&&!X.paused&&e-Cp>qp?Pm(!1):bp&&Nm();let o=Mm(e),s=Vm();(Np||s||r||X.cameraDrift||X.movingLight&&Pp)&&Hm(Op),X.growthPlayback&&!X.paused&&Lm()<Bp||o||i||X.cameraDrift&&!X.paused?nm():wp=0}function Xm(e){Uf.forEach(t=>{t.visible=e}),af.fog=e?of:null}function Zm(e){e&&(Object.values(e).forEach(e=>{e?.isTexture&&e.dispose()}),e.dispose?.())}function Qm(){if(wf&&(af.remove(wf),wf.traverse(e=>{e.isMesh&&(e.geometry?.dispose(),Array.isArray(e.material)?e.material.forEach(Zm):Zm(e.material))})),Tf.length){let e=new Set(Tf);for(let t=zf.length-1;t>=0;--t)e.has(zf[t])&&zf.splice(t,1)}wf=null,Tf=[],Ef=``,Df=null,Of=``,kf=``,Af=!1,jf=!1,Nf=!1,lf.enabled=!1,Uu.classList.remove(`is-model-source`,`is-orbiting`),Xm(!0),delete document.documentElement.dataset.modelView,delete document.documentElement.dataset.modelColor}function $m(e,t={}){e.position.set(0,0,0),e.scale.setScalar(1),e.updateWorldMatrix(!0,!0);let n=new $n().setFromObject(e);if(n.isEmpty())throw Error(`GLB 中没有可显示的几何体`);let r=n.getSize(new H),i=Math.max(r.x,r.y,r.z);if(!Number.isFinite(i)||i<=0)throw Error(`GLB 模型尺寸无效`);e.scale.setScalar(5.2/i),e.updateWorldMatrix(!0,!0);let a=new $n().setFromObject(e).getCenter(new H);e.position.sub(a),e.updateWorldMatrix(!0,!0);let o=new $n().setFromObject(e).getSize(new H),s=Math.max(1,o.length()*.5),c=t.cameraDistanceScale??1;Pf=Math.max(4.8,s/Math.sin(Mt.degToRad(sf.fov*.5))*.78)*c;let l=new H(.86,.52,1.25).normalize();sf.near=Math.max(.015,Pf/150),sf.far=Math.max(80,Pf*24),sf.position.copy(l.multiplyScalar(Pf)),sf.updateProjectionMatrix(),lf.target.set(0,0,0),lf.minDistance=Math.max(1.8,Pf*.34),lf.maxDistance=Pf*4.5,lf.enabled=!0,lf.update(),lf.saveState();let u=0,d=0,f=0;if(e.traverse(e=>{if(!e.isMesh)return;e.frustumCulled=!0,e.userData.semantic=tf.IMAGE,Tf.push(e),zf.push(e),f+=1;let t=e.geometry?.attributes?.position?.count||0;u+=t,d+=Math.round((e.geometry?.index?.count||t)/3)}),!f)throw Error(`GLB 中没有可生成笔触的网格`);Df={meshes:f,vertices:u,triangles:d,bytes:Number(t.size)||0,kind:Of?`default`:`glb`,preset:Of||null}}function eh(){ld.forEach(e=>{e.setAttribute(`aria-pressed`,String(e.dataset.defaultGeometry===Of))})}function th(e){return`#${new K(e).getHexString()}`}function nh(){let e=!!wf;dd.forEach(t=>{let n=!Af&&t.dataset.modelColor.toLowerCase()===kf;t.setAttribute(`aria-pressed`,String(n)),t.disabled=!e});let t=fd?.closest(`.model-color-custom`);fd.disabled=!e,t?.classList.toggle(`is-active`,e&&Af),t?.classList.toggle(`is-disabled`,!e),t?.style.setProperty(`--custom-model-color`,fd.value)}function rh(e,t=`自定义颜色`,n={}){if(!wf)return;let r=new K(e),i=new Set;Tf.forEach(e=>{(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>{e?.color&&i.add(e)})}),i.forEach(e=>{e.color.copy(r),e.needsUpdate=!0}),kf=th(r),Af=!!n.custom,Af&&(fd.value=kf),document.documentElement.dataset.modelColor=kf,nh(),jf=!0,yp=!0,Sp=!0,Np=!0,Y.textContent=`模型颜色 · ${t}`,Fm(),nm()}function ih(){let e=!!wf&&X.viewMode===3,t=!!wf&&X.viewMode===5;sd?.setAttribute(`aria-pressed`,String(e)),cd?.setAttribute(`aria-pressed`,String(t))}function ah(e){return e?Fd===`en`&&e.titleEn||e.title:``}function oh(){let e=!!wf,t=!!mf,n=t&&!!yf;td.textContent=e?Of?`默认几何体`:`GLB 模型`:n?`内置场景`:t?`原图`:`内置场景`,nd.textContent=e?Ef:t?gf:`正在准备内置场景`,nd.title=nd.textContent,Td.disabled=!e&&n||!vf,Td.hidden=Td.disabled,Dd.textContent=ah(vf)||Id(`selectWork`),document.documentElement.dataset.sourceMode=e?`model`:n?`builtin`:t?`image`:`scene`,document.documentElement.dataset.modelSource=e?Of||`glb`:`none`,id.hidden=!e,e&&(ad.textContent=Ef.split(` · `)[0],od.textContent=`${Df.meshes} ${Id(`meshCount`)} · ${Df.triangles.toLocaleString()} ${Id(`triangleCount`)}`),gd.dataset.i18n=e?`model3d`:`original`,_d.dataset.i18n=e?`dragToRotate`:`noStrokes`,gd.textContent=Id(gd.dataset.i18n),_d.textContent=Id(_d.dataset.i18n),Uu.title=Id(e?`modelCanvasHint`:`canvasHint`),Uu.classList.toggle(`is-model-source`,e),vd.classList.toggle(`is-model-layout`,e),pd.hidden=!e,eh(),nh(),ih(),Ed?.querySelectorAll(`.scene-card`).forEach(e=>{let t=e.dataset.sceneId===yf;e.classList.toggle(`is-selected`,t),e.setAttribute(`aria-pressed`,String(t))})}function sh(e){let t=[0,1,3,5].includes(Number(e))?Number(e):5,n=X.viewMode,r=!!wf&&n===3&&t===5;X.viewMode=t,X.showBase=!1,kd.forEach(e=>{e.checked=Number(e.value)===t});let i=t===5?`brush`:t===3?`original`:t===1?`flow-sketch`:`blend`;return document.documentElement.dataset.layerMode=i,ih(),Np=!0,n!==t&&(Mp=!0),r&&zh(),t===1&&(Y.textContent=`流场手稿 · 与最终笔触共用长度、弯度和生长轨迹`),nm(),r}function ch(){let e=X.brushLayers.map(e=>+!!e);[$f,ep,tp].forEach(t=>{t.uniforms.uBrushLayerVisibility.value.set(...e)}),Ad.forEach(e=>{let t=Number(e.dataset.brushLayer);e.checked=X.brushLayers[t]}),document.documentElement.dataset.brushLayers=e.join(``),Mp=!0,Np=!0,Fm(),nm()}function lh(e={}){Wm(),xp=!0,sm(),X.cameraDrift=!1,wf||(sf.near=.1,sf.far=80,sf.position.set(0,4.8,10.5),sf.lookAt(cf),sf.updateProjectionMatrix()),sh(e.viewMode??5),kp+=1,fp=[],dp=null,yp=!0,Sp=!0,Mp=!0,Pm(!0),!jm(e.strokeMorphSnapshot)&&(km(1),Rp=!1,document.documentElement.dataset.strokeMorphState=`idle`,$d?($d=!1,X.growthPlayback=!1,Pp=!1,Np=!0,zm(Bp),Y.textContent=`已按减少动态效果偏好显示完成画面`,nm()):zh())}function uh(e){let t=Math.min(4096,Z.capabilities.maxTextureSize||4096),n=e.naturalWidth||e.width,r=e.naturalHeight||e.height,i=Math.min(1,t/Math.max(n,r));if(i>=.999)return e;let a=document.createElement(`canvas`);a.width=Math.max(1,Math.round(n*i)),a.height=Math.max(1,Math.round(r*i));let o=a.getContext(`2d`,{alpha:!0});if(!o)throw Error(`无法建立图片缩放画布`);return o.drawImage(e,0,0,a.width,a.height),a}function dh(e){let t=new Yt(e);return t.colorSpace=He,t.minFilter=l,t.magFilter=l,t.generateMipmaps=!1,t.needsUpdate=!0,t}async function fh(e){let t=Ff[e];if(!t)return;Sf&&yh(!1);let n=++bf;Y.textContent=`正在生成${t.label} · 准备 3D 预览`;let r=null;try{let i=t.create();i.computeVertexNormals();let a=new ii(i,new Oa({color:t.color,roughness:.72,metalness:.02,side:2}));if(t.rotation&&a.rotation.set(...t.rotation),a.name=t.label,r=new kn,r.name=`Default ${t.label}`,r.add(a),Qm(),hf?.dispose(),hf=null,mf=null,gf=``,yf=``,Of=e,kf=th(t.color),Af=!1,document.documentElement.dataset.modelColor=kf,Tf=[],wf=r,af.add(wf),Xm(!1),$m(wf,t),Ef=`${t.label} · 内置几何体 · 可实时旋转`,oh(),await new Promise(e=>requestAnimationFrame(e)),n!==bf)return;lh({viewMode:3}),Y.textContent=`${t.label}已载入 · 拖动模型实时调整笔触方向`}catch(e){if(wf===r?Qm():r?.traverse(e=>{e.geometry?.dispose(),Array.isArray(e.material)?e.material.forEach(Zm):Zm(e.material)}),n!==bf)return;let t=e instanceof Error?e.message:String(e);Y.textContent=`默认几何体生成失败 · ${t}`,window.__vangoghFlowErrors.push(t)}}async function ph(e,t={}){if(!e)return;let n=t.requestToken??++bf,r=t.builtInScene||null;if(!r&&Sf&&yh(!1),!r&&e.type&&!e.type.startsWith(`image/`)){Y.textContent=`请选择 JPG、PNG 或 WebP 图片`;return}Y.textContent=`正在读取图片 · ${r?.title||e.name}`;let i=URL.createObjectURL(e);try{let a=new Image;a.decoding=`async`,a.src=i,await a.decode();let o=a.naturalWidth||a.width,s=a.naturalHeight||a.height;if(!o||!s)throw Error(`图片没有可读取的尺寸`);let c=uh(a);if(n!==bf)return;Qm(),hf?.dispose(),mf=c,hf=dh(c),ff.uniforms.uImage.value=hf;let l=c.width!==o||c.height!==s;if(r?(vf=r,yf=r.id,gf=`${r.title} · ${o}×${s} WebP · 保持比例`):(yf=``,gf=`${e.name} · ${o}×${s}${l?` → ${c.width}×${c.height}`:``} · 保持比例`),oh(),await new Promise(e=>requestAnimationFrame(e)),n!==bf)return;if(lh({strokeMorphSnapshot:t.strokeMorphSnapshot}),r){let e=performance.now()-(t.sceneSwitchStarted||performance.now());document.documentElement.dataset.activeSceneId=r.id,document.documentElement.dataset.sceneSwitchMs=e.toFixed(2),document.documentElement.dataset.sceneSwitchState=`ready`,Fm()}}catch(e){let t=e instanceof Error?e.message:String(e);Y.textContent=`图片读取失败 · ${t}`,window.__vangoghFlowErrors.push(t)}finally{URL.revokeObjectURL(i),rd.value=``}}function mh(e){return!!e&&(e.name?.toLowerCase().endsWith(`.glb`)||e.type===`model/gltf-binary`||e.type===`model/gltf+binary`)}async function hh(e){if(!e)return;if(Sf&&yh(!1),!mh(e)){Y.textContent=`请选择单文件 GLB 模型`;return}let t=++bf;Y.textContent=`正在解析 GLB · ${e.name}`,yd.classList.add(`is-loading`);try{let[{GLTFLoader:n},r]=await Promise.all([Hu(()=>import(`./GLTFLoader-B3oaXjWN.js`),[],import.meta.url),e.arrayBuffer()]);if(t!==bf)return;let i=await new n().parseAsync(r,``);if(t!==bf)return;if(!i.scene)throw Error(`GLB 没有可读取的主场景`);Qm(),hf?.dispose(),hf=null,mf=null,gf=``,yf=``,Tf=[],wf=i.scene,af.add(wf),Xm(!1),$m(wf,e);let a=e.size>=1048576?`${(e.size/1048576).toFixed(1)} MB`:`${Math.max(1,Math.round(e.size/1024))} KB`;if(Ef=`${e.name} · GLB · ${a} · 本地处理`,oh(),await new Promise(e=>requestAnimationFrame(e)),t!==bf)return;lh({viewMode:3}),Y.textContent=`GLB 已载入 · 拖动模型实时调整笔触方向`}catch(e){let t=e instanceof Error?e.message:String(e);wf&&!Ef&&Qm(),Y.textContent=`GLB 读取失败 · ${t}`,window.__vangoghFlowErrors.push(t)}finally{yd.classList.remove(`is-loading`),rd.value=``}}function gh(e){if(!e?.src)return Promise.reject(Error(`场景资源地址无效`));let t=e.src.includes(`?`)?`&`:`?`,n=`${e.src}${t}v=${encodeURIComponent(e.assetVersion||`${e.width}x${e.height}`)}`;if(xf.has(n))return xf.get(n);let r=fetch(n,{cache:`default`}).then(e=>{if(!e.ok)throw Error(`场景资源 ${e.status}`);return e.blob()}).catch(e=>{throw xf.delete(n),e});return xf.set(n,r),r}function _h(){Od.disabled=_f.length<2,Od.setAttribute(`aria-pressed`,String(Sf)),Od.dataset.i18n=Sf?`stopTour`:`startTour`,Od.textContent=Id(Od.dataset.i18n)}function vh(e=Hp){clearTimeout(Cf),Cf=0,!(!Sf||_f.length<2)&&(Cf=window.setTimeout(()=>{Cf=0;let e=Math.max(0,_f.findIndex(e=>e.id===yf));bh(_f[(e+1)%_f.length])},e))}function yh(e){Sf=!!e&&_f.length>1,clearTimeout(Cf),Cf=0,_h(),document.documentElement.dataset.sceneTour=Sf?`playing`:`idle`,Y.textContent=Sf?`自动巡展已开启 · 内置原作将以笔触变形衔接`:`自动巡展已停止`,Sf&&vh(900),Fm(),nm()}async function bh(e){if(!e||yf===e.id&&mf)return;let t=performance.now(),n=++bf,r=yf&&mf?Am():null;vf=e,document.documentElement.dataset.sceneSwitchState=`loading`,Dd.textContent=`${Id(`loadingWork`)} · ${ah(e)}`;let i=Ed?.querySelector(`[data-scene-id="${e.id}"]`);i?.classList.add(`is-loading`),Y.textContent=`正在载入内置场景 · ${e.title}`;try{let i=await gh(e);if(n!==bf)return;await ph(new File([i],`${e.id}.webp`,{type:`image/webp`}),{builtInScene:e,requestToken:n,sceneSwitchStarted:t,strokeMorphSnapshot:r})}catch(e){let t=e instanceof Error?e.message:String(e);Y.textContent=`内置场景读取失败 · ${t}`,window.__vangoghFlowErrors.push(t)}finally{i?.classList.remove(`is-loading`),n===bf&&Sf&&vh()}}function xh(){Ed&&(Ed.replaceChildren(),_f.forEach(e=>{let t=document.createElement(`button`);t.className=`scene-card`,t.type=`button`,t.dataset.sceneId=e.id,t.setAttribute(`role`,`listitem`),t.setAttribute(`aria-label`,`${Id(`loadingWork`)} ${ah(e)}`),t.title=`${e.title} · ${e.titleEn}`;let n=document.createElement(`img`),r=e.thumb.includes(`?`)?`&`:`?`;n.src=`${e.thumb}${r}v=${encodeURIComponent(e.assetVersion||`${e.width}x${e.height}`)}`,n.alt=``,n.loading=`lazy`,n.decoding=`async`;let i=document.createElement(`span`);i.textContent=ah(e),t.append(n,i),t.addEventListener(`pointerenter`,()=>{gh(e).catch(()=>{})},{once:!0}),t.addEventListener(`focus`,()=>{gh(e).catch(()=>{})},{once:!0}),t.addEventListener(`click`,()=>bh(e)),Ed.append(t)}),oh())}async function Sh(){try{let e=await fetch(`./scenes/manifest.json`);if(!e.ok)throw Error(`场景清单 ${e.status}`);let t=await e.json();if(!Array.isArray(t)||t.length===0)throw Error(`场景清单为空`);_f=t,vf=_f[Math.floor(Math.random()*_f.length)],_h(),xh(),await bh(vf)}catch(e){let t=e instanceof Error?e.message:String(e);Ed?.replaceChildren(Object.assign(document.createElement(`span`),{className:`scene-loading`,textContent:`内置场景暂时不可用`})),Y.textContent=`内置场景初始化失败 · ${t}`,window.__vangoghFlowErrors.push(t)}}function Ch(){bh(vf||_f[0])}function wh(e){let t=pp/Math.max(1,mp);return t>=1?[e,Math.max(2,Math.round(e/t))]:[Math.max(2,Math.round(e*t)),e]}function Th(){return typeof MediaRecorder>`u`||typeof MediaRecorder.isTypeSupported!=`function`?null:[{mimeType:`video/mp4;codecs=avc1.42E01E`,extension:`mp4`,label:`MP4`},{mimeType:`video/webm;codecs=vp9`,extension:`webm`,label:`WebM`},{mimeType:`video/webm;codecs=vp8`,extension:`webm`,label:`WebM`},{mimeType:`video/webm`,extension:`webm`,label:`WebM`}].find(({mimeType:e})=>MediaRecorder.isTypeSupported(e))||null}function Eh(e,t=`webm`){return e.includes(`mp4`)?`mp4`:e.includes(`webm`)?`webm`:t}function Dh(e=1){return new Promise(t=>{let n=Math.max(1,e),r=()=>{--n,n<=0?t():requestAnimationFrame(r)};requestAnimationFrame(r)})}function Oh(e=450){return new Promise(t=>{let n=[],r=!1,i=()=>{if(r)return;if(r=!0,clearTimeout(o),n.length<2){t(0);return}let e=n.at(-1)-n[0];t(e>0?(n.length-1)*1e3/e:0)},a=t=>{r||(n.push(t),n.length>1&&t-n[0]>=e?i():requestAnimationFrame(a))},o=setTimeout(i,e+800);requestAnimationFrame(a)})}function kh(){return new Promise((e,t)=>{let n=0,r=setTimeout(()=>{cancelAnimationFrame(n),t(Error(`实时录制超过 8 秒，已自动停止`))},Gp),i=()=>{if(Lm()>=4.99){clearTimeout(r),e();return}n=requestAnimationFrame(i)};n=requestAnimationFrame(i)})}function Ah(e,t){let n=URL.createObjectURL(e),r=document.createElement(`a`);r.href=n,r.download=t,r.click(),setTimeout(()=>URL.revokeObjectURL(n),4e3)}function jh(){return!!(Th()&&typeof Z.domElement.captureStream==`function`)}function Mh(e,t=Id(`exportVideo`)){Fp=e,Sd.classList.toggle(`is-busy`,e),Sd.textContent=t,Sd.disabled=e||!jh(),xd.disabled=e,Cd.disabled=e,wd.disabled=e,jd.disabled=e,bd.disabled=e,document.documentElement.dataset.videoRecording=e?`recording`:`idle`,Fm()}function Nh(){let e=!!(Th()&&typeof Z.domElement.captureStream==`function`);Sd.disabled=!e,document.documentElement.dataset.videoExportSupported=String(e),document.documentElement.dataset.videoRecording=`idle`}async function Ph(){if(Fp||xd.classList.contains(`is-busy`))return;let e=Th();if(!e||typeof Z.domElement.captureStream!=`function`){Y.textContent=`当前浏览器不支持画布视频录制`,Nh();return}let t=null,n=null,r=0;Mh(!0,Id(`checkingPerformance`));try{let i=await Oh();if(document.documentElement.dataset.videoPreflightFps=i.toFixed(1),i<Wp){Y.textContent=`当前约 ${i.toFixed(0)} FPS，为避免卡顿已取消录制`;return}if(zh(),Rh(!0),Bm(0),await Dh(2),t=Z.domElement.captureStream(Up),t.getVideoTracks().length===0)throw Error(`画布没有可录制的视频轨道`);let a=[],o=null;n=new MediaRecorder(t,{mimeType:e.mimeType,videoBitsPerSecond:Kp});let s=new Promise(e=>{n.onstop=e});n.ondataavailable=e=>{e.data?.size&&a.push(e.data)},n.onerror=e=>{o=e.error||Error(`浏览器录制器发生错误`)};let c=Z.domElement.width,l=Z.domElement.height;if(n.start(1e3),jp=Ap,Pp=!1,Mp=!0,Rh(!1),Y.textContent=`正在录制生长动画 · ${c}×${l}`,r=setInterval(()=>{Sd.textContent=`${Id(`recording`)} ${Lm().toFixed(1)} / ${Bp.toFixed(1)} ${Id(`seconds`)}`},100),await kh(),await Dh(2),n.stop(),await s,o)throw o;let u=n.mimeType||e.mimeType,d=new Blob(a,{type:u});if(!d.size)throw Error(`浏览器未能编码视频`);let f=Eh(d.type,e.extension),p=`wet-paint-flow-growth-${c}x${l}.${f}`;Ah(d,p),document.documentElement.dataset.lastVideoExport=p,document.documentElement.dataset.lastVideoMime=d.type,document.documentElement.dataset.lastVideoBytes=String(d.size),document.documentElement.dataset.lastVideoDuration=Bp.toFixed(1),document.documentElement.dataset.lastVideoSize=`${c}x${l}`,Y.textContent=`视频导出完成 · ${c}×${l} ${f.toUpperCase()}`}catch(e){let t=e instanceof Error?e.message:String(e);Y.textContent=`视频导出失败 · ${t}`,window.__vangoghFlowErrors.push(t)}finally{clearInterval(r),n&&n.state!==`inactive`&&n.stop(),t?.getTracks().forEach(e=>e.stop()),Mh(!1)}}async function Fh(){if(!up||Fp||xd.classList.contains(`is-busy`))return;let[e,t]=wh(4096),n=im(e,t,{depth:!0}),r=im(e,t,{depth:!1}),i=im(e,t,{depth:!1}),a=Z.getRenderTarget(),o=Z.domElement.width,s=Z.domElement.height,c=$f.uniforms.uResolution.value.clone(),l=ep.uniforms.uResolution.value.clone(),u=tp.uniforms.uResolution.value.clone(),d=$f.uniforms.uStrokeScale.value,f=ep.uniforms.uStrokeScale.value,p=tp.uniforms.uStrokeScale.value,m=np.uniforms.uScene.value,h=np.uniforms.uStroke.value,g=np.uniforms.uHeight.value,_=np.uniforms.uTexel.value.clone(),v=up.material;xd.classList.add(`is-busy`),xd.disabled=!0,Sd.disabled=!0,xd.textContent=`正在渲染 4K…`,Y.textContent=`高清导出 · ${e}×${t}`;try{mf?lm(n,0,mf,hf):um(n);let a=e/Math.max(1,pp)*1.12;$f.uniforms.uResolution.value.set(e,t),ep.uniforms.uResolution.value.set(e,t),tp.uniforms.uResolution.value.set(e,t),$f.uniforms.uStrokeScale.value=a,ep.uniforms.uStrokeScale.value=e/Math.max(1,pp)*.34,tp.uniforms.uStrokeScale.value=a,up.material=X.viewMode===1?ep:$f,Z.setRenderTarget(r),Z.setClearColor(0,0),Z.clear(!0,!0,!0),Z.render(Kf,qf),up.material=tp,Z.setRenderTarget(i),Z.setClearColor(0,0),Z.clear(!0,!0,!0),Z.render(Kf,qf),np.uniforms.uScene.value=n.texture,np.uniforms.uStroke.value=r.texture,np.uniforms.uHeight.value=i.texture,np.uniforms.uTexel.value.set(1/e,1/t),Z.setRenderTarget(null),Z.setSize(e,t,!1),Z.setViewport(0,0,e,t),Z.setClearColor(0,1),Z.clear(!0,!0,!0),Z.render(Jf,Yf);let o=await new Promise(e=>Z.domElement.toBlob(e,`image/png`));if(!o)throw Error(`浏览器未能编码 PNG`);Ah(o,`wet-paint-flow-${e}x${t}.png`),Y.textContent=`导出完成 · ${e}×${t} PNG`,document.documentElement.dataset.lastExport=`${e}x${t}`}catch(e){let t=e instanceof Error?e.message:String(e);Y.textContent=`导出失败 · ${t}`,window.__vangoghFlowErrors.push(t)}finally{up.material=v,$f.uniforms.uResolution.value.copy(c),ep.uniforms.uResolution.value.copy(l),tp.uniforms.uResolution.value.copy(u),$f.uniforms.uStrokeScale.value=d,ep.uniforms.uStrokeScale.value=f,tp.uniforms.uStrokeScale.value=p,np.uniforms.uScene.value=m,np.uniforms.uStroke.value=h,np.uniforms.uHeight.value=g,np.uniforms.uTexel.value.copy(_),Z.setSize(o,s,!1),Z.setRenderTarget(a),n.dispose(),r.dispose(),i.dispose(),Np=!0,nm(),xd.classList.remove(`is-busy`),xd.disabled=!1,xd.textContent=Id(`exportPng`),Sd.disabled=!jh()}}rd.addEventListener(`change`,e=>{let t=e.target.files?.[0];mh(t)?hh(t):ph(t)}),Od.addEventListener(`click`,()=>yh(!Sf)),ld.forEach(e=>{e.addEventListener(`click`,()=>fh(e.dataset.defaultGeometry))}),ud.addEventListener(`change`,()=>{X.liveModelAnalysis=ud.checked,document.documentElement.dataset.liveModelAnalysis=String(X.liveModelAnalysis),Y.textContent=X.liveModelAnalysis?`实时笔触跟随已开启 · 拖动时动态重建`:`实时笔触跟随已关闭 · 松手后一次定稿`,Fm(),nm()}),dd.forEach(e=>{e.addEventListener(`click`,()=>rh(e.dataset.modelColor,e.getAttribute(`aria-label`)||`自定义颜色`))}),fd.addEventListener(`input`,()=>rh(fd.value,fd.value.toUpperCase(),{custom:!0})),md.addEventListener(`input`,()=>{Nf=!0,Rf(md.value)}),md.addEventListener(`change`,()=>{Nf=!1,Rf(md.value,{finalize:!0})}),Td.addEventListener(`click`,Ch),xd.addEventListener(`click`,Fh),Sd.addEventListener(`click`,Ph),Uu.addEventListener(`wheel`,Km,{passive:!1}),Uu.addEventListener(`dblclick`,qm),sd.addEventListener(`click`,()=>{sh(3),Y.textContent=`3D 模型预览 · 拖动旋转，滚轮调整距离`}),cd.addEventListener(`click`,()=>{Y.textContent=sh(5)?`正在生成模型笔触 · 粗层 → 中层＋细层 → 稳定收尾`:`模型笔触结果 · 调整角度会实时重建`});var Ih=0,Lh=e=>Array.from(e.dataTransfer?.types||[]).includes(`Files`);window.addEventListener(`dragenter`,e=>{Lh(e)&&(e.preventDefault(),Ih+=1,vd.classList.add(`is-dragging`),yd.classList.add(`is-dragging`))}),window.addEventListener(`dragover`,e=>{Lh(e)&&(e.preventDefault(),e.dataTransfer&&(e.dataTransfer.dropEffect=`copy`))}),window.addEventListener(`dragleave`,e=>{Lh(e)&&(Ih=Math.max(0,Ih-1),Ih===0&&(vd.classList.remove(`is-dragging`),yd.classList.remove(`is-dragging`)))}),window.addEventListener(`drop`,e=>{if(!Lh(e))return;e.preventDefault(),Ih=0,vd.classList.remove(`is-dragging`),yd.classList.remove(`is-dragging`);let t=Array.from(e.dataTransfer?.files||[]),n=t.find(mh);n?hh(n):ph(t.find(e=>e.type.startsWith(`image/`)))}),window.addEventListener(`paste`,e=>{let t=Array.from(e.clipboardData?.files||[]).find(e=>e.type.startsWith(`image/`));t&&ph(t)}),document.querySelectorAll(`[data-param]`).forEach(e=>{let t=e.dataset.param,n=document.querySelector(`[data-output="${t}"]`);e.addEventListener(`input`,()=>{X[t]=Number(e.value),Np=!0,n&&(n.textContent=t===`strokeCountK`?Math.round(Number(e.value)*1e3).toLocaleString():Number(e.value).toFixed(2)),[`structure`,`geometry`,`semantic`].includes(t)&&(yp=!0),t===`length`&&(bp=!0),[`strokeSize`,`coverage`,`dryness`,`viscosity`,`bristleDetail`].includes(t)&&(Mp=!0),ed&&(ed.textContent=(X.structure+X.geometry+X.semantic).toFixed(2)),nm()})}),document.querySelector(`[data-param="strokeCountK"]`).addEventListener(`change`,()=>{Im(),zh()}),bd.addEventListener(`change`,e=>{X.qualityMode=e.target.value,xp=!0,Y.textContent=`正在切换${e.target.selectedOptions[0].textContent}画质…`,nm()}),kd.forEach(e=>{e.addEventListener(`change`,()=>{e.checked&&sh(e.value)})}),Ad.forEach(e=>{e.addEventListener(`change`,()=>{X.brushLayers[Number(e.dataset.brushLayer)]=e.checked,ch()})});function Rh(e){X.paused=e,wd.dataset.i18n=e?`resume`:`pause`,wd.textContent=Id(wd.dataset.i18n),wd.setAttribute(`aria-pressed`,String(e)),Y.textContent=e?`已暂停 · 笔触身份保持`:`实时运行 · 方向场已同步`,zm(),nm()}wd.addEventListener(`click`,()=>{X.paused&&Lm()>=4.99&&Bm(0),Rh(!X.paused)}),jd.max=String(Bp),jd.addEventListener(`pointerdown`,()=>Rh(!0)),jd.addEventListener(`input`,()=>{let e=Number(jd.value);X.paused||Rh(!0),Bm(e),Y.textContent=`已定位 · ${Rm(Lm())}`});function zh(){X.growthPlayback=!0,jp=Ap,Pp=!1,Mp=!0,X.paused&&Rh(!1),zm(0),Y.textContent=`正在生长 · 粗层 → 中层＋细层 → 稳定收尾`,nm()}function Bh(){Im(),zh(),Y.textContent=`已重建 · 新种子开始生长`}if(Cd.addEventListener(`click`,Bh),window.addEventListener(`keydown`,e=>{e.code===`Space`&&e.target===document.body&&(e.preventDefault(),Rh(!X.paused)),e.key.toLowerCase()===`b`&&!e.repeat&&(X.showBase=!0,Np=!0,nm())}),window.addEventListener(`keyup`,e=>{e.key.toLowerCase()===`b`&&(X.showBase=!1,Np=!0,nm())}),window.addEventListener(`resize`,()=>{let e=parseFloat(Wu.style.getPropertyValue(`--panel-width`));Wd()&&Number.isFinite(e)?qd(e):Kd(),xp=!0,nm()}),`ResizeObserver`in window){let e=new ResizeObserver(()=>{Bd||(xp=!0,nm())});e.observe(Uu),e.observe(vd)}Nd.addEventListener(`click`,()=>{Fd=Fd===`zh`?`en`:`zh`;try{localStorage.setItem(`wet-paint-flow-language`,Fd)}catch{}wd.dataset.i18n=X.paused?`resume`:`pause`,Ld(),xh(),oh(),zm(),Nh()}),Ld(),Kd(),oh(),sh(5),zm(Qd?Bp:0),Nh(),Um(1),Rf(X.modelLightAngle),nm(),Sh();export{xi as $,Lr as A,s as B,Zi as C,Ue as D,u as E,ka as F,Eo as G,On as H,Oa as I,Yo as J,ia as K,a as L,G as M,ii as N,to as O,Kr as P,He as Q,o as R,Qi as S,d as T,Do as U,Wa as V,So as W,Ka as X,Nt as Y,r as Z,Ia as _,Mr as a,V as at,qi as b,W as c,kn as d,gi as et,No as f,Fr as g,Nr as h,_r as i,so as it,Mt as j,Ao as k,ko as l,Ai as m,_i as n,wo as nt,i as o,H as ot,Si as p,$i as q,$n as r,Yt as rt,K as s,Ja as st,Ya as t,wr as tt,io as u,Ie as v,l as w,zi as x,Le as y,c as z};